...
def pose_controller(qp, d):
    ...
    kp = 3.0       # Gain for position error
    kalpha = 9.0   # Gain for alignment error
    kbeta = -3.0    # Gain for orientation error
    l = 1 # Wheelbase length in meters

    # Constraints (these values should be set according to vehicle specifications)
    max_velocity = 6    # Maximum linear velocity (m/s)
    max_acceleration = 9.8/6    # Maximum linear acceleration (m/s^2)
    max_turn_angle = math.pi/3      # Maximum turning angle (radians)
