...
def get_model_instance_segmentation(num_classes):
    ...
    #checkpoint = torch.load('/home/adas/adas/torch/checkpoints/fasterrcnn_resnet50_fpn_coco-258fb6c6.pth')
...
def box_finder(image_path):
    ...
    model.load_state_dict(torch.load('parking_slot_detector.pth',map_location=device))
    model.eval()
